...
public class Write4VO {

	private int article3_seq;
	...
	public Write4VO(int articles3_seq, String subject, String content, String img_pic1, String img_pic2, String img_pic3,
			String memberId, Date reg_date, int cnt, int rec_cnt, String nickname) {
		super();
		this.article3_seq = articles3_seq;
	...
	public void setArticles_seq(int articles_seq) {
		this.article3_seq = articles_seq;
	}
