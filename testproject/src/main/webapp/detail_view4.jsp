...
Write4VO writevo = (Write4VO)session.getAttribute("write4vo");
replyDAO rdao = new replyDAO();
ArrayList<replyVO> al = rdao.dselect(writevo.getArticles_seq(),"QA");
...
<div data-include-path="header.jsp"></div>
 <section class="section1">
 	<form action="articlecommentcon4">
        <div class="board_wrap">
            <div class="board_title">
              <strong><a href="notice_board.jsp">문의사항</a></strong>
            </div>
